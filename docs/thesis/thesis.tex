...
- What is camera calibration in general terms?

- Why is camera calibration a fundamental prerequisite for accurate computer vision?

- Why do we need a camera calibration

- How does camera calibration relate to the previous sections (camera model and distortion)?
